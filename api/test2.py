...
#first week Monday Tuesday Thursday
apicall(["json.json","json2.json"],0,50000)
apicall(["json.json","json4.json"],1,50000)
apicall(["json3.json"],3,20000)


#second week Monday
apicall(["json3.json"],0,50000)

#third week Monday 
apicall(["json4.json"],0,50000)

##print function
k=0
print("global budget ")
print("Monday 1 : ",expenses[0][0])
print("Tuesday 1 : ",expenses[1][0])
print("Thursday 1 : ",expenses[3][0])
print("the expenses for the week 1 : ", weekly_budget(1))
print("\n")
for elt in expenses[0][:place]:
    k+=1
    print("Monday ",k," : ",elt)
print("prediction for monday 4 :", train_model(0))
